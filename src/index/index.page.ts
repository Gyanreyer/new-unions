...
import { BookAppointmentModal } from '../_components/BookAppointmentModal.component.ts';

export const config = {
  permalink: "/",
};

const IndexPage: YetiPageComponent = () => html`<${PageBorderLayout} itemscope itemtype="http://schema.org/Store">
  <${Header} />
  <main>
    <${IntroSection} />
    <${OfferingsSection} />
